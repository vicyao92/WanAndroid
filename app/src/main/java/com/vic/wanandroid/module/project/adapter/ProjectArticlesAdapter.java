package com.vic.wanandroid.module.project.adapter;
...
public class ProjectArticlesAdapter extends BaseQuickAdapter<ArticleBean, BaseViewHolder> {
    private Context mContext;

    public ProjectArticlesAdapter(int layoutResId, List data, Context context) {
